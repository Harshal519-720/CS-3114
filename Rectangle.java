...
// the distance from the y coordinate the rectangle spans
	...
	/**
	 * Creates an object with the values to the parameters given in the xCoordinate,
	 ...
	 *
	 * @param r2 Rectangle parameter
	 * @return true if the rectangle intersects with rec, false if not
	 */
	public boolean intersect(Rectangle r2) {
		return xCoordinate < r2.xCoordinate + r2.width && xCoordinate + width > r2.xCoordinate
				&& yCoordinate < r2.yCoordinate + r2.height && yCoordinate + height > r2.yCoordinate;
	}

	/**
	 * Checks, if the invoking rectangle has the same coordinates as rec.
	 *
	 * @param rec the rectangle parameter
	 * @return true if the rectangle has the same coordinates as rec, false if not
	 */
	@Override
	public boolean equals(Object rec) {
		...
		return xCoordinate == other.xCoordinate && yCoordinate == other.yCoordinate && width == other.width
				&& height == other.height;
	}

	/**
	 * Outputs a human readable string with information about the rectangle which
	 * includes the x and y coordinate and its height and width
	 *
	 * @return a human readable string containing information about the rectangle
	 */
	@Override
	...
	public boolean isInvalid() {
		return xCoordinate < 0 || yCoordinate < 0 || width <= 0 || height <= 0 || xCoordinate + width > 1024
